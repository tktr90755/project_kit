...
function shareOfLine() {
  var shareUrl = "";
  var message = encodeURIComponent("TEST\n http://test.jp/ \n#test");
  var lineUrl = "http://line.me/R/msg/text/?" + message + " " + shareUrl;
...
function shareOfTwitter() {
  ...
  var message = encodeURIComponent("TEST\n http://test.jp/ \n#test");
  var hashTag = "";
  var twitterUrl = "https://twitter.com/intent/tweet?url=" + shareUrl + "&text=" + message;
